...
{
    public class AgentCreatorUtilsTest
    {
        ...
        public void CreateAgent_Throws_WhenEndpointConfigIsMissing()
        {
            ...
            var ex = Assert.Throws<InvalidOperationException>(() => AgentCreatorUtils.CreateAgent(creator, agentParameters));
        ...
        public void CreateAgent_Throws_WhenEndpointConfigIsEmpty()
        {
            ...
            Assert.Throws<InvalidOperationException>(() => AgentCreatorUtils.CreateAgent(creator, agentParameters));
        }
        ...
        public void CreateAgent_PassesAgentParametersAndProjectClient_ToMapper()
        {
            ...
            var result = AgentCreatorUtils.CreateAgent(creator, agentParameters);
